        ...
        App::new()
            ...
            .service(
                web::scope("")
                    ...
                    .route("/v1/common/getImageListShort", web::get().guard(guard::Get()).to(handlers::get_common_short_image_list))
                    .route("/v1/common/getImageListDetailed", web::get().guard(guard::Get()).to(handlers::get_common_detailed_image_list))
                    ...
                    // Containers API
                    .route("/v1/containers/getState", web::get().guard(guard::Get()).to(handlers::get_containers_status))
                    .route("/v1/containers/getState/{id}", web::get().guard(guard::Get()).to(handlers::get_containers_status_query))
