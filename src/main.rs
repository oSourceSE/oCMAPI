        ...
        App::new()
            ...
            .service(
                web::scope("")
                    ...
                    // Common API
                    .route("/v1/common/stats", web::get().guard(guard::Get()).to(handlers::get_common_stats))
                    .route("/v1/common/version", web::get().guard(guard::Get()).to(handlers::get_common_version))
                    .route("/v1/common/info", web::get().guard(guard::Get()).to(handlers::get_common_info))
                    // Containers API
                    .route("/v1/containers/status", web::get().guard(guard::Get()).to(handlers::get_containers_status))
                    .route("/v1/containers/status/{id}", web::get().guard(guard::Get()).to(handlers::get_containers_status_query))
                    .route("/v1/containers/create", web::post().guard(guard::Post()).to(handlers::post_containers_create))
                    .route("/v1/containers/setstate", web::post().guard(guard::Post()).to(handlers::post_containers_setstate))
                    // Pods API
                    .route("/v1/pods/status", web::get().guard(guard::Get()).to(handlers::get_pods_status))
                    .route("/v1/pods/status/{id}", web::get().guard(guard::Get()).to(handlers::get_pods_status_query))
                    .route("/v1/pods/create", web::post().guard(guard::Post()).to(handlers::post_pods_create))
                    .route("/v1/pods/setstate", web::post().guard(guard::Post()).to(handlers::post_pods_setstate))
                    // Networks API
                    .route("/v1/networks/info", web::get().guard(guard::Get()).to(handlers::get_networks_info))
                    .route("/v1/networks/info/{id}", web::get().guard(guard::Get()).to(handlers::get_networks_info_single))
                    .route("/v1/networks/create", web::post().guard(guard::Post()).to(handlers::post_networks_create))
            )
        })
