        ...
        App::new()
            ...
            .service(
                web::scope("")
                    ...
                    .route("/v1/containers/postCreate", web::post().guard(guard::Post()).to(handlers::post_containers_create))
                    .route("/v1/containers/postSetState", web::post().guard(guard::Post()).to(handlers::post_containers_setstate))
                    .route("/v1/containers/postRename", web::post().guard(guard::Post()).to(handlers::post_containers_rename))
                    ...
                    .route("/v1/pods/postCreate", web::post().guard(guard::Post()).to(handlers::post_pods_create))
                    ...
                    .route("/v1/networks/postCreate", web::post().guard(guard::Post()).to(handlers::post_networks_create))
